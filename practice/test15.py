...
webBrowser.get("http://sso.xnwmall.com/mall/login.shtml")
webBrowser.find_element_by_id("userName").send_keys('15699999999')#用户名
webBrowser.find_element_by_id("password").send_keys('wwg111')#密码
webBrowser.find_element_by_id("subLoginBtn").click()#登录按钮
time.sleep(5)
