    ...
    def request(self):
        try:
            while 1:
                ...
                #     self.page)
                request_url = 'http://image.baidu.com/search/acjson?tn=resultjson_com&ipn=rj&ct=201326592&is=&fp=result&queryWord=%E7%BE%8E%E5%A5%B3&cl=2&lm=-1&ie=utf-8&oe=utf-8&adpicid=&st=-1&z=&ic=0&word=%E7%BE%8E%E5%A5%B3&s=&se=&tab=&width=&height=&face=0&istype=2&qc=&nc=1&fr=&cg=girl&pn=' + str(
                    self.page) + '&rn=30&gsm=1e00000000001e&1487920679638='
    ...
    def download(self, data):
        ...
        for d in data:
            ...
            if d:
                ...
                FileName = str(r'F:\testresult\image') + item[0] + str('.jpg')
