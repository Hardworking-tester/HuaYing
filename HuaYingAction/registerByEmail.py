...
class Register(unittest.TestCase):
    ...
    def testRegisterByDifferentPassword(self):
        ...
        if self.br.current_url=='http://user.xnwmall.com/register/goRegister.shtml' and WebDriverWait(self.br,10).until(lambda br:self.br.find_element_by_xpath("//*[@id='regTelFrom']/div[1]/div/ul/li[2]/span").text)==alertmessage:
